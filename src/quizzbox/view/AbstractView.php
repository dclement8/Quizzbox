...
abstract class AbstractView {
    ...
    */
    ...
    public function __construct($data){
        $this->data = $data;
        $http = new \quizzbox\utils\HttpRequest();
    ...
    protected function renderHeader() {
		...
		$html .= "\t<a href='".$this->script_name."'>Quizzbox</a>\n";
		$html .= "</header>\n";
        return $html;
    }
    ...
    protected function renderFooter() {
        $html  = "<footer>\n";
		$html .= "\tProjet Tutoré Quizzbox ; 2017 ; CLEMENT Dylan - DALICHAMPT Thibaut - PIGUET Charles\n";
		$html .= "</footer>\n";
        return $html;
    }
    ...
    protected function renderMenu() {
		...
		$auth = new \quizzbox\utils\Authentification();
